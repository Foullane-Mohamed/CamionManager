        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
            >
              <option value="" className="text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800">Select driver</option>
              {drivers.map(d => (
                <option key={d._id} value={d._id} className="text-gray-900 dark:text-white bg-white dark:bg-gray-800">{d.name || `${d.firstName || ''} ${d.lastName || ''}`.trim()}</option>
              ))}
            </select>
