    ...
    <>
      ...
      >
        ...
        <nav className="h-full overflow-y-auto py-4">
          ...
          {userRole === "admin" && (
            <div className="px-4 py-4 mt-6 mx-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-xl border border-blue-200 dark:border-blue-800 shadow-sm">
          ...
          {userRole === "chauffeur" && (
            <div className="px-4 py-4 mt-6 mx-3 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950 dark:to-green-950 rounded-xl border border-emerald-200 dark:border-emerald-800 shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                <Car className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
